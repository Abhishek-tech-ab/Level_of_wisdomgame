...
wn = turtle.Screen()
wn.bgcolor("black")
wn.title("THE LEVEL OF WISDOM")
wn.setup(700, 700)
wn.tracer(0)
wn.clear()

image = ["plright.gif","plleft.gif","deleft.gif","deright.gif","kin.gif","TREASURE.gif"]
for image in image:
...
level_1 = [
    ...
    "xx     x      xx        xxxxxx",
    "xxx        x       xx       xx",
    "xxxxxxxx E  xxxx        xxxxxx",
    "xxxx          xxxxx  X     xxx",
    "xxxxxxxxE     xxxxxxxxxxxxxxxx",
    "xx      xxxx  T   xxxxx    xxx",
